-- DEBUG VERSION - CLEAN AND COMPLETE
-- Fixed all truncation issues and bundle type matching
-- Run this in Supabase SQL Editor, then check logs for NOTICE messages
