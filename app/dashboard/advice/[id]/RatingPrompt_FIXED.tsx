...
export default function RatingPrompt({ submissionId, deliveredAt }: RatingPromptProps) {
  ...
  const isWithin48Hours = deliveredAt
    ...
    : true // Default to true if deliveredAt is null (show text box)
  ...
  return (
    <div style={{
      ...
      {/* Thumbs up/down buttons - Always show */}
      <div style={{
        display: 'flex',
        gap: '16px',
        marginBottom: '24px',
        ...
        <button
          onClick={() => setSelectedThumb(false)}
          disabled={submitting}
          style={{
            padding: '16px 32px',
            fontSize: '2rem',
